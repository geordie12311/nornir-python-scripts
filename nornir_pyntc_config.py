"""
python pyntc test script using pyntc_config library
"""

import getpass
from nornir import InitNornir
from norinir_pyntc.tasks import pyntc_config
...
def send_config_test(task):
    task.run(task=pyntc_config, config="ntp server 10.10.10.150")
